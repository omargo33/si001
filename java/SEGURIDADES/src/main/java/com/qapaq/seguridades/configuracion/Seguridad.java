package com.qapaq.seguridades.configuracion;
...
import com.qapaq.seguridades.filter.AuthenticationFilter;
import com.qapaq.seguridades.filter.AuthorizationFilter;
import com.qapaq.seguridades.ConstantesSeguridades;
import com.qapaq.seguridades.jpa.model.VPermisoRol;
import com.qapaq.seguridades.servicio.UsuarioServicio;
import com.qapaq.seguridades.servicio.VPermisoRolServicio;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        AuthenticationFilter authenticationFilter = new AuthenticationFilter(authenticationManagerBean()) {
            ...
            public String generarMensajeError(HttpServletRequest request) {
                ...
                switch (estado) {
                    case ConstantesSeguridades.TOKEN_ESTADO_USUARIO_NO_EXISTE:
                        mensajeError = "W-GS00100-6";
                        break;
                    case ConstantesSeguridades.TOKEN_ESTADO_USUARIO_EXCEDE_NUMERO_INTENTOS:
                        mensajeError = "W-GS00100-7";
                        break;
                    case ConstantesSeguridades.TOKEN_ESTADO_INACTIVO:
                        mensajeError = "W-GS00100-8";
                        break;
                    case ConstantesSeguridades.TOKEN_ESTADO_ACTIVO:
                        mensajeError = "W-GS00100-6";
                        break;
                    case ConstantesSeguridades.TOKEN_ESTADO_CREADO:
                        mensajeError = "W-GS00100-6";
                        break;
                    default:
