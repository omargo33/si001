...
import com.qapaq.seguridades.jpa.queries.TokenRepositorio;
...
public class TokenServicio {
    ...
    public Token guardarToken(Token token, String usuario, String usuarioPrograma) {
        token.setEstado(ConstantesSeguridades.TOKEN_ESTADO_ACTIVO);
        token.setValidador(
    ...
    public boolean enviarToken(String correo, String ip, String userAgent, String usuarioPrograma) {
        ...
        token.setEstado(ConstantesSeguridades.TOKEN_ESTADO_CREADO);
    ...
    private void auditarSolicitudesFallidos(String correo, String ip, String userAgent, String usuarioPrograma) {
        ...
        this.auditoriaServicio.agregarParametro("correo", correo, ConstantesSeguridades.DIRECCION_IN);
        ...
        this.auditoriaServicio.agregarEnvento(userAgent, ConstantesSeguridades.TIPO_EVENTO_SEGURIDADES);
    }    
}
