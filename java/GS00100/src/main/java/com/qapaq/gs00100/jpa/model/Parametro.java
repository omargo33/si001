...
public class Parametro implements Serializable {
    ...
    /**
     * Metodo para crear la clase Parametro.
     * 
     */
    public Parametro() {
        super();
    ...
    /**
     * Metodos de setter y getter para la clase Parametro.
     */
    ...
    public String toString() {
        return "Parametro{" + "idParametro=" + idParametro + ", idModulo=" + idModulo + ", indice=" + indice
                + ", clave=" + clave + ", nombre=" + nombre + ", descripcion=" + descripcion + ", valorTexto01="
                + valorTexto01 + ", valorTexto02=" + valorTexto02 + ", valorNumero01=" + valorNumero01
                + ", valorNumero02=" + valorNumero02 + ", defaultTexto01=" + defaultTexto01 + ", defaultTexto02="
                + defaultTexto02 + ", defaultNumero01=" + defaultNumero01 + ", defaultNumero02=" + defaultNumero02
