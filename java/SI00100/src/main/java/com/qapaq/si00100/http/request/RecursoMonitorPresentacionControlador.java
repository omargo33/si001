...
public class RecursoMonitorPresentacionControlador extends ComonControlador {
        ...
        @Autowired
        public RecursoMonitorPresentacionControlador(RecursoMonitorPresentacionServicio recursoMonitorPresentacionServicio) {
            this.recursoMonitorPresentacionServicio = recursoMonitorPresentacionServicio;
        }
    
        /**
        * Metodo para obtener un recursoMonitorPresentacion por id_recursoMonitorPresentacion.
        */
        @GetMapping("/{id}")
        public RecursoMonitorPresentacion getRecursoMonitorPresentacionByIdRecursoMonitorPresentacion(@PathVariable(value = "id") Long idRecursoMonitorPresentacion) {
            return recursoMonitorPresentacionServicio.findByIdRecursoMonitorPresentacion(idRecursoMonitorPresentacion);
        }
    
        /**
        * Metodo para obtener un recursoMonitorPresentacion por id_monitor_recurso y paginado
        */
        @GetMapping("/idRecursoMonitor={idRecursoMonitor}")
        public List<RecursoMonitorPresentacion> getRecursoMonitorPresentacionByIdMonitorRecurso(@PathVariable(value = "idRecursoMonitor") Long idMonitorRecurso, Pageable pageable) {
         ...
         */
        @PostMapping("/")
        public RecursoMonitorPresentacion createRecursoMonitorPresentacion(@Valid @RequestBody RecursoMonitorPresentacion recursoMonitorPresentacion) {
            return recursoMonitorPresentacionServicio.save(recursoMonitorPresentacion, "getUsuario()", appName + " " + appVersion);
        }
}
