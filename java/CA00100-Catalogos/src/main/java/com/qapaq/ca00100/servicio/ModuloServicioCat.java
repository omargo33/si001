...
import com.qapaq.ca00100.jpa.queries.ModuloRepositorioCat;
...
public class ModuloServicioCat {

    @Autowired
    private final ModuloRepositorioCat moduloRepositorio;
    
    /**
     * Metodo para mostrar todos los modulos.
     */
    public List<ModuloCat> findAllModulos(Pageable pageable) {
     ...
     * @return
     */
    public List<ModuloCat> findByIndiceModulo(String indice, Pageable pageable){
     ...
     * 
     */
    public List<ModuloCat> findByNombreModulo(String nombre, Pageable pageable){
